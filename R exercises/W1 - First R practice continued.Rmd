...
head(____) #shows the first few lines (standard: 6 lines, can adjust with n = argument)
tail(____) #last few lines
str(____) #list of variables and types: numeric, factor (categorical) or text
...
gapminder2010 <- filter(gapminder, year==_____)
...
ggplot(________, aes(________)) + geom_histogram()
...
ggplot(gapminder2010, aes(life_expectancy, fill = _______)) + geom_histogram()
